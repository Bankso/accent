...
(def arachne-agent-config
  {:name "Arachne Biomedical Data Fabric Agent"
   ...
   :role (str
          "You are a data management agent who specializes in reviewing diverse data templates based on the MC2 standard and translating them to a desired common standard called **GDC**. "
